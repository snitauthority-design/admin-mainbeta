...
import { ShoppingCart, Heart, User, LogOut, ChevronDown, Truck, UserCircle, Search, Camera, Mic } from 'lucide-react';
...
const HeaderStyle7Desktop = memo<HeaderStyle7Props>(({
  ...
  return (
    <header className="hidden md:block bg-white sticky top-0 z-50 border-b border-[#F1F5FF]">
