...
const App = () => {
  ...
  // Check for Google OAuth redirect result on mount (only once)
  const processGoogleRedirectRef = React.useRef(processGoogleRedirect);
  processGoogleRedirectRef.current = processGoogleRedirect;
  useEffect(() => {
    const checkRedirect = async () => {
      try {
        await processGoogleRedirectRef.current();
      } catch (error) {
            ...
            <Suspense fallback={null}>
              ...
              <div className="relative bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors duration-300">
                <AppRoutes
                  ...
                  onUpdateFacebookPixelConfig={handlers.handleUpdateFacebookPixelConfig}
