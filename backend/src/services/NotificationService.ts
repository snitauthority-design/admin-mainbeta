...
// Get the API base URL - works in both browser (Vite/Next.js) and Node.js environments
const getApiBaseUrl = (): string => {
  // Browser environment - check import.meta.env (Vite) and process.env (Next.js)
  if (typeof window !== 'undefined') {
    try {
      // @ts-ignore - import.meta is available in Vite and shimmed in Next.js
    ...
    // Next.js environment - check process.env
    try {
