...
/**
 * GET /api/reviews/summary/:tenantId
 * Public endpoint: Get review count and average rating per product for a tenant
 */
reviewsRouter.get('/summary/:tenantId', async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const result: Record<number, { reviewCount: number; avgRating: number }> = {};
